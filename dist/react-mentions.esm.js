...
function (_React$Component) {
  ...
  function MentionsInput(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleChange", function (ev) {
      ...
      var newValue = newPlainTextValue === '@' ? applyChangeToValue(value, newPlainTextValue, {
        selectionStartBefore: _this.state.selectionStart,
        selectionEndBefore: _this.state.selectionEnd,
        selectionEndAfter: ev.target.selectionEnd
      }, config) : newPlainTextValue; // In case a mention is deleted, also adjust the new plain text value
